...
**P03/P04 扩展（2026-09-09）**：新增第 17 个独立开关 `p03_p04_grid_weather`，原 16 项和新开关目前均默认关闭并带中文注释。ERA5 区域日天气实验只完成实现与离线测试，尚未正式运行；启动、候选验收标准、产物和解释范围见 [P03/P04 指南](new_analysis/P03_P04_GRID_WEATHER.md)。下文“完整 16 步”指先前导师复现阶段。
